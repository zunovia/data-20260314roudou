...
const DATA = {
  ...
  di_current: [43.5, 50.0, 50.2, 51.4, 44.9, 28.7, 34.6, 44.9, 43.1, 44.8, 53.5, 48.1, 49.8, 45.5, 50.4, 48.6, 43.2, 34.7, 45.0, 47.0, 52.0, 48.5, 46.4, 46.8],
  di_forward:  [45.2, 51.4, 51.5, 52.9, 46.9, 31.6, 38.3, 44.6, 44.2, 46.5, 55.2, 47.4, 51.1, 47.4, 50.9, 50.5, 45.2, 36.0, 49.3, 47.3, 51.6, 49.5, 47.5, 51.2],

  // 直近12ヶ月（原系列）
  months12: ["2025-03", "2025-04", "2025-05", "2025-06", "2025-07", "2025-08", "2025-09", "2025-10", "2025-11", "2025-12", "2026-01", "2026-02"],
  di_m12_cur: [47.8, 44.6, 44.8, 45.1, 45.5, 46.3, 46.6, 48.5, 48.0, 48.5, 45.4, 48.2],
  di_m12_fwd: [46.6, 43.4, 46.1, 46.9, 47.0, 46.7, 48.2, 52.1, 48.8, 48.1, 50.6, 51.8],

  // 分野別DI（原系列、直近6時点）
  sector_labels: ["2025-03", "2025-05", "2025-07", "2025-09", "2025-11", "2026-01"],
  di_household:  [47.7, 44.8, 45.1, 45.8, 47.9, 44.4],
  di_corporate:  [47.8, 44.4, 47.1, 48.6, 48.9, 47.5],
  di_employment: [49.0, 46.3, 45.3, 47.7, 47.1, 47.7],

  // 地域別DI（季節調整値、最新3ヶ月平均）
  regions: ["全国", "北海道", "東北", "北関東", "南関東", "甲信越", "東海", "北陸", "近畿", "中国", "四国", "九州"],
  region_di: [47.8, 46.7, 46.5, 46.1, 48.3, 46.1, 47.7, 48.1, 47.6, 48.4, 47.8, 48.8],

  // 回答構成比（直近6ヶ月）
  months6: ["2025-09", "2025-10", "2025-11", "2025-12", "2026-01", "2026-02"],
  pct_good:        [2.0, 2.2, 2.6, 2.4, 1.5, 2.1],
  pct_fairly_good: [15.8, 18.8, 17.2, 19.3, 14.5, 19.1],
  pct_same:        [51.8, 54.4, 54.3, 52.3, 54.8, 51.6],
  pct_fairly_bad:  [24.0, 19.9, 21.6, 21.8, 22.6, 21.9],
  pct_bad:         [6.3, 4.6, 4.3, 4.1, 6.7, 5.3],
};
